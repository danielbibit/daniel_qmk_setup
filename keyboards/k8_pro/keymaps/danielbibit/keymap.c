...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [DAN_WIN] = LAYOUT_ansi_87(
         ...
         MT(MOD_LCTL, KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, LT(MOUSE_FN, KC_ENT),

         KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP,

         KC_NO, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, KC_RGUI, MO(CONFIG), KC_NO, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [DAN_WIN_FN] = LAYOUT_ansi_87(
         ...
         KC_LCTL, _______, _______, _______, KC_HOME, KC_END, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, _______, KC_PGDN, KC_INS,
