...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [GAME_LAYER] = LAYOUT_ansi_61(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, KC_RGUI, MO(CONFIG), KC_RCTL
    ),
    ...
    [CONFIG] = LAYOUT_ansi_61(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, TO(GAME_LAYER), TO(DAN_WIN), _______,
